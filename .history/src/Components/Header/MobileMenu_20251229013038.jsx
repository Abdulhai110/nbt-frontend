      ...
      <div className="th-menu-area text-center">
        ...
        <div className="th-mobile-menu">
          <ul>
            {/* Home */}
            <li
              className={`menu-item-has-children mega-menu-wrap th-item-has-children ${
            ...
            >
              ...
              >
                ...
                <li>
                  <Link to="/home-tour">Home Tour</Link>
                </li>
                <li>
            ...
            <li
              className={`menu-item-has-children th-item-has-children ${
                activeMenu === 5 ? "th-active" : ""
              }`}
            >
              <Link to="#" onClick={() => toggleMenu(5)}>
                Pages
              </Link>
              <ul
              ...
              >
                ...
                <li>
                  <Link to="/resot/1">Resort Details</Link>
                </li>
                <li>
