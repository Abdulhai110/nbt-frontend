                            ...
                            <div className="gallery-card">
                                <div className="box-img global-img">
                                    <Link
                                        ...
                                        onClick={(e) => openModal(images[0].imageUrl, images[0].titlem, e)}
                                    >
                                    ...
                                    <img
                                        ...
                                        alt="gallery"
                                        onClick={(e) => openModal(images[0].imageUrl, images[0].title, e)}
                                    />
                                </div>
                            </div>
                        )}
                            ...
                            <div className="gallery-card">
                                <div className="box-img global-img">
                                    <Link
                                        ...
                                        className="popup-image"
                                        onClick={(e) => openModal(images[1].imageUrl, images[1].title, e)}
                                    >
                                        <div className="icon-btn">
                                            <i className="fal fa-magnifying-glass-plus" />
                                        </div>
                            ...
                            <div className="gallery-card">
                                <div className="box-img global-img">
                                    <Link
                                        ...
                                        className="popup-image"
                                        onClick={(e) => openModal(images[2].imageUrl, images[2].title, e)}
                                    >
                                        <div className="icon-btn">
                                            <i className="fal fa-magnifying-glass-plus" />
                                        </div>
                            ...
                            <div className="gallery-card">
                                <div className="box-img global-img">
                                    <Link
                                        ...
                                        className="popup-image"
                                        onClick={(e) => openModal(images[3].imageUrl, images[3].title, e)}
                                    >
                                        <div className="icon-btn">
                                            <i className="fal fa-magnifying-glass-plus" />
                                        </div>
                            ...
                            <div className="gallery-card">
                                <div className="box-img global-img">
                                    <Link
                                        ...
                                        className="popup-image"
                                        onClick={(e) => openModal(images[4].imageUrl, images[4].title, e)}
                                    >
                                        <div className="icon-btn">
                                            <i className="fal fa-magnifying-glass-plus" />
                                        </div>
                            ...
                            <div className="gallery-card">
                                <div className="box-img global-img">
                                    <Link
                                        ...
                                        className="popup-image"
                                        onClick={(e) => openModal(images[5].imageUrl, images[5].title, e)}
                                    >
                                        <div className="icon-btn">
                                            <i className="fal fa-magnifying-glass-plus" />
                                        </div>
                            ...
                            <div className="gallery-card">
                                <div className="box-img global-img">
                                    <Link
                                        ...
                                        className="popup-image"
                                        onClick={(e) => openModal(images[6].imageUrl, images[6].title, e)}
                                    >
                                        <div className="icon-btn">
                                            <i className="fal fa-magnifying-glass-plus" />
                                        </div>
