          ...
          <div className="col-xl-7">
            <div className="img-box3">
              ...
              <div className="img3 movingX">
                <img
                  src="/assets/img/normal/about_4.jpg"
                  alt="About"
                  style={{ height: "500px" }}
                />
              </div>
            ...
            <div className="ps-xl-4">
              <div className="title-area mb-20">
                <span className="sub-title style1 ">
                  Welcome To North Blossom Travel And Tours
                </span>
              ...
              <p className="pe-xl-5">
                <strong>North Blossom Travel and Tours,</strong> registered under License No. 2513 from the Department of Tourist Services in Pakistan, offers customized trips for families and couples at discounted prices with flexible dates. We understand the unique needs and preferences of different groups, and our experienced team works closely with clients to create personalized itineraries that cater to their specific interests and budgets.
              </p>
