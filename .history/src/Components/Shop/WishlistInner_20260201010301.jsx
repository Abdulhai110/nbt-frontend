        ...
        <div className="tinv-wishlist woocommerce tinv-wishlist-clear">
          ...
          <div className="social-buttons">
            ...
            <ul>
              ...
              <li>
                <Link
                  to="https://x.com/share?url=permalink"
              ...
              <li>
                <Link
                  to="http://pinterest.com/pin/create/button/?url=permalink"
              ...
              <li>
                <Link
                  to="https://api.whatsapp.com/send?text=permalink"
